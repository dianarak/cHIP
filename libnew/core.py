...
def calc_sigmas_average(substituents, sum_sigma_hammett, sum_sigma_exp, TheilSen=False, get_dummies=True):
    ...
    ----------
        ...
        sum_sigma_hammett: pd.Series with the sum of the sigmas obtained from the original Hammett parameters, 
                            or from any other method for finding individual sigmas that you wish to compare with this one
    ...
    d_sum = {'Sigma_calc': sum_sigma_calc, 'Sigma_exp': b, 'Sigma_hammett': sum_sigma_hammett}
    ...
    if TheilSen:
        ...
        d_sum_theil = {'Sigma_calc': sum_sigma_calc_theil, 'Sigma_exp': sum_sigma_exp, 'Sigma_hammett': sum_sigma_hammett}
        ...
        print('MAE theil hammett - exp:', mae_theil, 'std dev:', np.std(sum_sigma_hammett - sum_sigma_exp))
